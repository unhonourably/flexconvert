  ...
  return (
    <div className="p-8 max-w-7xl mx-auto">
      ...
      <div className={`mb-8 transition-all duration-500 delay-200 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-2'}`}>
        <h1 className="text-5xl font-extrabold text-white mb-3 bg-gradient-to-r from-white to-gray-400 bg-clip-text text-transparent">Dashboard</h1>
      ...
      <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8 transition-all duration-500 delay-400 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
